 ...
 *
 */
public class Assignment71 extends Assignment{
	...
	protected void createAssignment() {
		...
		addEvent(new Event("EventB", 30000, 30000));
		...
		behavior.addCondition("End", "[EventA] OR [EventB]");
		addBehavior(behavior);
		
		CaseType caseType = new CaseType(30000, 30000, "[End]", 1000000, new String[] {"Start","EventA","End"});
